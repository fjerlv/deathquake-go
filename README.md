...
You can configure DeathQuake Go to ignore specific game sessions by their hash.
...
2. When a round ends (score is posted), the game hash will be logged:
   ```
...
Add the game hash to `config.json`:
